...
class _SelectLanguageScreenState extends State<SelectLanguageScreen> {
    ...
    return Scaffold(
      body: SafeArea(child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            getText(title: getTranslated('choose', context)!,
                size: 35, fontFamily: FontFamily.poppinsMedium,
                color: AppColor.blueColor, fontWeight: FontWeight.w700),
            getText(title: getTranslated('your_language', context)!,
                size:17, fontFamily: FontFamily.poppinsMedium,
  ...
  chooseLanguageWidget(String title,String subTitle, String language,int index){
    return GestureDetector(
      onTap: (){
        ...
        Provider.of<LocalizationProvider>(context,
            listen: false)
            .setLanguage(Locale(
          Constants.languages[selectLanguage]
              .languageCode!,
          Constants.languages[selectLanguage]
              .countryCode,
        ));
      ...
      child: DottedBorder(
          ...
          child: Container(
            ...
            color: selectLanguage==index? AppColor.lightPinkColor.withOpacity(.08):AppColor.lightTextColor.withOpacity(.08),
            padding:const EdgeInsets.all(12),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                getText(title: title,
                    size: 20, fontFamily: FontFamily.poppinsMedium, color: AppColor.blueColor,
                    fontWeight: FontWeight.w800),
                ScreenSize.height(15),
                getText(title: subTitle,
                    size: 17, fontFamily: FontFamily.poppinsMedium, color: AppColor.blackColor,
                    fontWeight: FontWeight.w600),
                ScreenSize.height(30),
                Align(
                  alignment: Alignment.centerRight,
                  child: getText(title: language,
                      size: 18, fontFamily: FontFamily.poppinsMedium, color: AppColor.blackColor,
                      fontWeight: FontWeight.w600),
                )
              ],
            ),
