...
class _SingUpScreenState extends State<SingUpScreen> {
  ...
  checkValidation(){
    ...
    if(fomKey.currentState!.validate()&&provider.profileImage!=null&&provider.passportImage!=null){
      AppRoutes.pushCupertinoNavigation(const VechileInfoScreen(route: '',));
    }
    setState(() { 
        ...
        builder: (context,myProvider,child) {
          return Form(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ScreenSize.height(15),
                 const  getText(title: "Departments/ City",
                      size: 12, fontFamily: FontFamily.poppinsMedium, color: AppColor.lightTextColor,
                      fontWeight: FontWeight.w400),
                  ScreenSize.height(6),
                  SignUpTextField(hintText: "Enter department or city",
                    textInputAction: TextInputAction.next,
                    controller: myProvider.addressController,validator: (val){
                      if(val.isEmpty){
                        return 'Enter department or city';
                      }
                    },),
                  ScreenSize.height(15),
                 const  getText(title: 'Country',
                      size: 12, fontFamily: FontFamily.poppinsMedium, color: AppColor.lightTextColor,
                      fontWeight: FontWeight.w400),
                  ScreenSize.height(6),
                  SignUpTextField(hintText: "Enter your country",
                    textInputAction: TextInputAction.next,
                    controller: myProvider.addressController,validator: (val){
                      if(val.isEmpty){
            ...
            ScreenSize.height(6),
                  ...
                  ScreenSize.height(15),
                const getText(title: 'State identity document',
                      size: 12, fontFamily: FontFamily.poppinsMedium, color: AppColor.lightTextColor,
                      fontWeight: FontWeight.w400),
                  ScreenSize.height(6),
                  ...
                  ScreenSize.height(25),
                  AppButton(title: getTranslated('next', context)!,
                      height: 56, width: double.infinity, buttonColor: AppColor.appTheme,
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> OtpVerifyScreen(email: 'rraviggupta', phone: '9782485409', route: 'signup')));
                    // checkValidation();
                      })
                ],
              ),
