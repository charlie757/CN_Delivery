...
class VechileInfoScreen extends StatefulWidget {
  String route;
  VechileInfoScreen({required this.route});
...
class _VechileInfoScreenState extends State<VechileInfoScreen> {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                getText(
                    title: getTranslated('vehicle_type', context)!,
                    size: 12,
                    fontFamily: FontFamily.poppinsMedium,
                    color: AppColor.lightTextColor,
                    fontWeight: FontWeight.w400),
                ...
                SignUpTextField(
                  hintText:
                      getTranslated('select_vehicle_type_validation', context)!,
                  isReadOnly: true,
                  controller: myProvider.vehicleTypeController,
                  validator: (val) {
                    if (val.isEmpty) {
                      return getTranslated(
                          'select_vehicle_type_validation', context)!;
                    }
                  },
                  onTap: () {
                    showBottomSheet();
                ...
                SignUpTextField(
                  ...
                  onTap: () {
                    myProvider
                        .datePicker(myProvider.selectedDORDate)
                        .then((val) {
                      if (val != null) {
                  ...
                  validator: (val) {
                    if (val.isEmpty) {
                      return getTranslated(
                          'select_registration_date', context)!;
                    }
                  },
                  isReadOnly: true,
                  suffix: SizedBox(
                ...
                getText(
                    title: getTranslated('fuel_type', context)!,
                    size: 12,
                    fontFamily: FontFamily.poppinsMedium,
                    color: AppColor.lightTextColor,
                    fontWeight: FontWeight.w400),
                ...
                SignUpTextField(
                  hintText:
                      getTranslated('select_fuel_type_validation', context)!,
                  isReadOnly: true,
                  controller: myProvider.fuelController,
                  validator: (val) {
                    if (val.isEmpty) {
                      return getTranslated(
                          'select_fuel_type_validation', context)!;
                    }
                  },
                  onTap: () {
                    fuelTypeBottomSheet();
                ...
                SignUpTextField(
                  hintText:
                      getTranslated('enter_registration_number', context)!,
                  ...
                  validator: (val) {
                    if (val.isEmpty) {
                      return getTranslated(
                          'enter_registration_number', context)!;
                    }
                  },
                ),
                ScreenSize.height(15),
  ...
  bycycleWidget(SignupProvider provider) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        getText(
